...
public class DBMahasiswa extends SQLiteOpenHelper{
    ...
    //InnerClass, gawe ngatur artibut koyok Nama Tabel, nama-nama kolom dan Query
    ...
    private static final String NamaDatabse = "polinema.db";
    private static final int VersiDatabase = 14;

    //Query yang digunakan pas membuat Tabel
